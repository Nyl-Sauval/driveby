...
class ClientFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'client_birth' => $this->faker->date('d-m-Y', '-18 years'),
            ...
            'client_license_issue_date' => $this->faker->date('d-m-Y', '-5 years'),
            'client_license_expiry_date' => $this->faker->date('d-m-Y', '+5 years'),
